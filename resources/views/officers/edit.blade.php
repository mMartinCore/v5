...
<div class="col-lg-10  col-lg-offset-1" style="background:white"><br>
       ...
       <div class="box text-left box-default">
                     <div class="box-header   with-border">
                       <h3 class="box-title">
                                   <a href="/officers/{{$officer->id}}" class="btn btn-default">Back To Profile</a>
                           Edit Member </h3>
                      </div>
                  </div>
{!! Form::open(['action' => ['OfficersController@update', $officer->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="row">
                     ...
                     <div class=" col-sx-12    col-sm-12  col-md-12  col-lg-3  ">
                            <div class="form-group">
                                    ...
                                    {{Form::text('id', $officer->id, ['class' => 'form-control', 'placeholder' => 'eg":15506'])}}
                                    <span>.</span>
                                </div>
                                ...
                                <div class="form-group{{$errors->has('nis') ? 'has-error' :''}} ">
                                        {{Form::label('nis', 'NIS')}}
                                    {{Form::text('nis', $officer->nis, ['class' => 'form-control', 'placeholder' => 'P- 89585..'])}}
                                    <span>.</span>
                                 </div>

                                 <div class="form-group {{$errors->has('enlist_date') ? 'has-error' :''}} ">
                                        {{Form::label('enlist_date', 'Enlistment Date')}}
                                        {{Form::text('enlist_date',  $officer->enlist_date, ['class' => ' enlist_date form-control', 'placeholder' => 'eg:'])}}
                                        <span>.</span>
                                    </div>
                      ...
                      <div class=" col-sx-12    col-sm-12  col-md-12  col-lg-3  ">
                            <div class="form-group {{$errors->has('reg_no') ? 'has-error' :''}} ">
                                  {{Form::label('reg_no', 'Regulation Number')}}
                                    {{Form::text('reg_no', $officer->reg_no, ['class' => 'form-control', 'placeholder' => 'eg":15506'])}}
                                    <span>.</span>
                             </div>

                                <div class="form-group {{$errors->has('suffix') ? 'has-error' :''}} ">
                                        {{Form::label('suffix', 'Suffix')}}
                                        {{Form::text('suffix', $officer->suffix, ['class' => 'form-control', 'placeholder' => 'eg:OD'])}}
                                        <span>.</span>
                                 </div>
                                 <div class="form-group {{$errors->has('dob') ? 'has-error' :''}} ">
                                        {{Form::label('dob', 'Date of Birth')}}
                                        {{Form::text('dob',  $officer->dob, ['class' => ' dob form-control', 'placeholder' => '1997-08-17'])}}
                                        <span>.</span>
                      ...
                      <div class=" col-sx-12    col-sm-12  col-md-12  col-lg-3  ">
                            <div class="form-group {{$errors->has('trn') ? 'has-error' :''}} ">
                                    {{Form::label('trn', 'TRN')}}
                                    {{Form::text('trn',  $officer->trn, ['class' => 'form-control', 'placeholder' => 'eg:117008498'])}}
                                    <span>.</span>
                                </div>

                                <div class="form-group {{$errors->has('title') ? 'has-error' :''}} ">
                                        {{Form::label('title', 'Title')}}
                                        {{Form::text('title',  $officer->title, ['class' => 'form-control', 'placeholder' => 'Title'])}}
                                        <span>.</span>
                                 </div>
                                 <div class="form-group {{$errors->has('sex') ? 'has-error' :''}} ">
                                          {{Form::label('sex', 'Gender')}}
                                          <select name="sex" value="{{Request::old('sex')}}" class="form-control" >
                                          <option value="{{$officer->sex}}">{{$officer->sex}}</option>
        ...
        <div class="row">
                <div class="col-6 col-sm-4">    <div class="form-group {{$errors->has('status') ? 'has-error' :''}} ">
                        {{Form::label('status_id', 'Status')}}
                       <select name="status_id" value="{{Request::old('status_id')}}" class="form-control" >
                ...
                <div class="col-6 col-sm-4">   <div class="form-group {{$errors->has('original_rank') ? 'has-error' :''}} ">
                            ...
                            <option value="{{$officer->original_rank}}">{{$officer->original_rank}}</option>
              ...
              <div class="row">
                    <div class="col-6 col-sm-4">    <div class="form-group {{$errors->has('last_name') ? 'has-error' :''}} ">
                            ...
                            {{Form::text('last_name',  $officer->last_name, ['class' => 'form-control', 'placeholder' => ''])}}
                            <span>.</span>
                     </div></div>
                     <div class="col-6 col-sm-4">   <div class="form-group {{$errors->has('first_name') ? 'has-error' :''}} ">
                            {{Form::label('first_name', 'First Name')}}
                            {{Form::text('first_name',  $officer->first_name, ['class' => 'form-control', 'placeholder' => ''])}}
                            <span>.</span>
                     </div> </div>
                    <div class="col-6 col-sm-4">    <div class="form-group {{$errors->has('middle_name') ? 'has-error' :''}} ">
                            {{Form::label('middle_name', 'Middle Name')}}
                            {{Form::text('middle_name',  $officer->middle_name, ['class' => 'form-control', 'placeholder' => ''])}}
                            <span>.</span>
                     </div></div>
                  ...
                  <div class="row">
                        <div class="col-6 col-sm-6">    <div class="form-group {{$errors->has('station') ? 'has-error' :''}} ">
                                ...
                                {{Form::text('station',  $officer->station, ['class' => 'form-control', 'placeholder' => ''])}}
                                <span>.</span>
                         </div></div>
                         <div class="col-6 col-sm-6">   <div class="form-group {{$errors->has('section') ? 'has-error' :''}} ">
                                {{Form::label('section', 'Section')}}
                                {{Form::text('section',  $officer->section, ['class' => 'form-control', 'placeholder' => ''])}}
                                <span>.</span>
                         </div> </div>
        ...
        <div class="col-6 col-sm-6">    <div class="form-group {{$errors->has('nationality') ? 'has-error' :''}} ">
                ...
                {{Form::text('nationality',  $officer->nationality, ['class' => 'form-control', 'placeholder' => ''])}}
                <span>.</span>
         </div></div>
         <div class="col-6 col-sm-6">   <div class="form-group {{$errors->has('cob') ? 'has-error' :''}} ">
                ...
                <option value="{{$officer->cob}}">{{$officer->cob}}</option>
        ...
        <div class="form-group {{$errors->has('remarks') ? 'has-error' :''}} ">
            ...
            {{Form::textarea('remarks',  $officer->remarks, ['id' => 'article-ckeditor', 'class' => 'form-control', 'placeholder' => 'Type here...'])}}
        </div>
...
<script>
              ...
              $(document).ready(function() {
                     var imageFromDb='  <img width="190px" height="215px"     src="/storage/images/{{$officer->image}}">';
                     $('.img1').append(imageFromDb);
              })
