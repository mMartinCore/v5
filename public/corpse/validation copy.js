...
var finger_print_date =false;
var  finger_print =false;
var gazetted =false;
var gazetted_date =false;
var pauper_burial_requested  =false;
var  pauper_burial_requested_date =false;
var  pauper_burial_approved =false;
var  pauper_burial_approved_date =false;
var buried= false;
var burial_date= false;
...
$("#PauperBurialRequestedShow").slideUp();
...
{
    if (isfirstDateGreaterThanSecondDate("pickup_date","gazetted_date")== true && isfirstDateGreaterThanSecondDate("postmortem_date","gazetted_date")== true
        && isfirstDateGreaterThanSecondDateNotReq("gazetted_date","pauper_burial_requested_date")== true  )
     {     // TESTIG FOR TRUE
            gazetted_date =true;
            if ( gazetted_date) {
               $("#PauperBurialRequestedShow").slideDown();
            }
...
{
    if (isfirstDateGreaterThanSecondDate( "gazetted_date","pauper_burial_requested_date")== true && isfirstDateGreaterThanSecondDate("postmortem_date","pauper_burial_requested_date" )== true
